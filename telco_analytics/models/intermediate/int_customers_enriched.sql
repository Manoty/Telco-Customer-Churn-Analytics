...
enriched as (
    ...
    select
        ...
        case
            ...
            when tenure_months between 25 and 48 then 4
            else 5
        ...
        round(
            coalesce(total_charges, monthly_charges * tenure_months), 2
        )                                           as lifetime_value,
        ...
        -- Service count (how many add-ons does this customer have)
        (
        ...
        -- High value flag: above median monthly charges + more than 2 add-ons
        case
            when monthly_charges >= 65
